...
<body>
	...
	<br />
	<p align="center">
		<a href="nou_Locatie.jsp"><b>Adauga o noua locatie.</b></a> <a
	...
	<form action="m1_Locatie.jsp" method="post">
		<table border="1" align="center">
			<tr>
				<td><b>Mark:</b></td>
				<td><b>Id Locatie:</b></td>
				<td><b>Adresa:</b></td>
				<td><b>Oras:</b></td>
				<td><b>Numele Farmaciei:</b></td>
			</tr>
			<%
			jb.connect();
			ResultSet rs = jb.vedeLocatii();
			long x;
			while (rs.next()) {
				x = rs.getInt("idLocatie");
			%>
			<tr>
				<td><input type="checkbox" name="primarykey" value="<%=x%>" /></td>
				<td><%=rs.getInt("idLocatie")%></td>
